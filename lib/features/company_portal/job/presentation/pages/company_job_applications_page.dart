// company_portal/job/presentation/pages/company_job_applications_page.dart
...
class CompanyJobApplicationsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final applicationsAsync = ref.watch(jobApplicationsForJobProvider(jobId));
      ...
      body: applicationsAsync.when(
        data: (applications) {
          ...
          return RefreshIndicator(
            onRefresh: () async {
              ref.invalidate(jobApplicationsForJobProvider(jobId));
            },
        ...
        error: (error, stack) => Center(
          child: Column(
            ...
            children: [
              ...
              TextButton(
                onPressed: () => ref.invalidate(jobApplicationsForJobProvider(jobId)),
...
class _ApplicationCard extends ConsumerWidget {
  ...
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final isLoading = ref.watch(jobApplicationManagementNotifierProvider).isLoading;
  ...
  void _approve(BuildContext context, WidgetRef ref) async {
    final notifier = ref.read(jobApplicationManagementNotifierProvider.notifier);
    final success = await notifier.approve(application.id, jobId);
